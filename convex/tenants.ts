...
export const create = mutation({
  args: {
    ...
    primaryForegroundColor: v.optional(v.string()),
    secondaryForegroundColor: v.optional(v.string()),
    heroImage: v.optional(v.string()),
    seoImage: v.optional(v.string()),
    favicon: v.optional(v.string()),
    tagline: v.optional(v.string()),
    poweredByLink: v.optional(v.string()),
  ...
  handler: async (ctx, args) => {
    ...
    const tenantId = await ctx.db.insert("tenants", {
      ...
      primaryForegroundColor: args.primaryForegroundColor,
      secondaryForegroundColor: args.secondaryForegroundColor,
      heroImage: args.heroImage,
      seoImage: args.seoImage,
